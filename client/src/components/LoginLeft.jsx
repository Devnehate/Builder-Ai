...
const LoginLeft = () => {
  return (
    <div className="flex w-2/5 min-h-screen bg-[url('/bg-img.png')] bg-cover bg-center bg-no-repeat flex-col justify-between p-12 shrink-0 select-none">
      ...
      <div>
        ...
        <p className="text-zinc-300">
          ...
          in real-life. React with clean JSX, verified layouts, and instant
          code exports.
        </p>
